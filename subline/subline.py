...
class product_template(Model):
    ...
    possibilities = fields.Many2one('product.product', 'Product', domain=[('sale_ok', '=', True)], readonly=True)
    options = fields.Many2one('product.product', 'Product', domain=[('sale_ok', '=', True)], readonly=True)
